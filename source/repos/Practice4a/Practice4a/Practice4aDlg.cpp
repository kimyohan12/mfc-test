...
// Practice4aDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "Practice4a.h"
#include "Practice4aDlg.h"
...
CPractice4aDlg::CPractice4aDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_PRACTICE4A_DIALOG, pParent)
	, m_strEdit(_T(""))
{
...
void CPractice4aDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CPractice4aDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
//	ON_LBN_SELCHANGE(IDC_LIST_OUTPUT, &CPractice4aDlg::OnLbnSelchangeListOutput)
	ON_COMMAND(IDC_RADIO1, &CPractice4aDlg::OnRadio1)
	ON_COMMAND(IDC_RADIO2, &CPractice4aDlg::OnRadio2)
	ON_BN_CLICKED(IDC_CHECK1, &CPractice4aDlg::OnClickedCheck1)
	ON_BN_CLICKED(IDC_CHECK2, &CPractice4aDlg::OnClickedCheck2)
	ON_BN_CLICKED(IDC_BUTTON_ADD, &CPractice4aDlg::OnClickedButtonAdd)
	ON_BN_CLICKED(IDC_BUTTON_INSERT, &CPractice4aDlg::OnClickedButtonInsert)
	ON_BN_CLICKED(IDC_BUTTON_DELETE, &CPractice4aDlg::OnClickedButtonDelete)
END_MESSAGE_MAP()


// CPractice4aDlg 메시지 처리기

BOOL CPractice4aDlg::OnInitDialog()
{
...
void CPractice4aDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CPractice4aDlg::OnQueryDragIcon()
{
...
//void CPractice4aDlg::OnLbnSelchangeListOutput()
//{
...
{
	// TODO: 여기에 구현 코드 추가.
	int nCnt = m_listBox.GetCount();    // 리스트 박스의 현재 아이템의 수를 반환
	m_cbListItem.ResetContent();        // 콥보박스의 모든 아이템 삭제
...
void CPractice4aDlg::OnClickedButtonInsert()
{
	...
	{
		AfxMessageBox(_T("콤보 박스에서 삽입활 아이템을 선택하세요. "));
	}
